...
@WebServlet(name = "DispprovedReceivedRequestFormServlet")
public class DispprovedReceivedRequestFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet result = q.getDisapprovedRequestFormBySendTo(q.getDepartmentFromId(id));
