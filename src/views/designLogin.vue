<template>
  <div>
    ...
    <v-container style="position: relative;">
      <v-card class="mx-auto" max-width="688" min-height="250"
        style="border-top-right-radius: 2em;border-top-left-radius: 2em;">
        <!--bottom box / color: white-->
        <v-card class="mx-auto" max-width="688" min-height="300"
          ...
          <v-row>
            ...
            <v-col cols="8" style="justify-items: center;align-items: center;display:grid;"> <br />
              <img src="../assets/logo-white2.png" style="width: 200px;" /></v-col>
            <v-col cols="2"></v-col>
            <v-col cols="2"></v-col>
            <!-- MSG: Welcome -->
        ...
        <v-row>
          ...
          <v-col cols="8" class="scopeBox2">
            <!-- Back-End Zone-->
            <v-text-field v-model="name" :rules="nameRules" :error-messages="nameErrors" :counter="10" label="Name"
              required @input="$v.name.$touch()" @blur="$v.name.$touch()" @keypress.enter="login" style="width: 90%;">
            </v-text-field>
            <v-text-field v-model="password" :rules="pwRules" :error-messages="passwordErrors" label="Password" required
              type="password" @input="$v.password.$touch()" @blur="$v.password.$touch()" @keypress.enter="login"
              style="width: 90%;">
            </v-text-field>
          </v-col>
        </v-row>
